...
foreach ($items as $key => $item) {
    $content = "# 每日与主同行 {$key} —— {$item['title']}";
    $content .= PHP_EOL;
    $content .= PHP_EOL;
    $content .= "<video width='100%' controls src='https://go2024.simai.life/api?redirect=https://r2.savefamily.net/@pastorpaulqiankunlu618/{$item['vid']}.mp4?metric=PastorLu%26keyword=webpage%26type=video%26bot=26%26to=webpage'></video>";
    $content .= PHP_EOL;
    
    $content .= "<a href='../daily.html'> 返回 </a>".PHP_EOL;
    $content .= "<p>扫一扫 或 微信中 长按 下面的二维码，即可加卢牧师微信</p>".PHP_EOL;
    $content .= "<img src='https://r2.savefamily.net/OVagt1.JPG' width='500px' />".PHP_EOL;

    $content .= PHP_EOL;
    $content .= PHP_EOL;
    $content .= PHP_EOL;
    $content .= '<iframe width="100%" height="500" src="https://www.youtube.com/embed/'.$item['vid'].'?si=zz5OCgHQvyW71w8c&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';

    file_put_contents("Daily/{$key}.md", $content);
}